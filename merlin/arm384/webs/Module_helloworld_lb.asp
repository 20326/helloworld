...
<body onload="init();">
	...
	<input type="hidden" name="current_page" value="Module_helloworld_lb.asp"/>
	<input type="hidden" name="next_page" value="Module_helloworld_lb.asp"/>
